...
SECRET_KEY = 'django-insecure-=wo+w9*g^h_7=6dpsy*$@gw9=6t7ow4%jdgc7%9usu-dn&%vt%'
...
ASGI_APPLICATION = 'mysite.asgi.application'  # Replace `mysite`

# ✅ Use InMemoryChannelLayer for local testing
CHANNEL_LAYERS = {
    "default": {
...
EMAIL_HOST_PASSWORD = "App_Pass"  # Replace with your email app password
